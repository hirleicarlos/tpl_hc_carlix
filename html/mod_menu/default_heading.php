...
?>
<span class="mod-menu__heading nav-header <?php echo htmlspecialchars($anchorCss, ENT_QUOTES, 'UTF-8'); ?>"<?php echo $title . $submenuAttributes; ?>><?php echo $linktype; ?></span>
